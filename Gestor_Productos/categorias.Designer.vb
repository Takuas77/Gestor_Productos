...
Namespace categoriasTableAdapters
    ...
    Partial Public Class categoriasTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `inventariodb`.`categorias` WHERE ((`IdCategoria` = :Original_IdCateg"& _ 
                "oria) AND ((:IsNull_Categoria = 1 AND `Categoria` IS NULL) OR (`Categoria` = :Or"& _ 
                "iginal_Categoria)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `inventariodb`.`categorias` (`Categoria`) VALUES (:Categoria)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `inventariodb`.`categorias` SET `Categoria` = :Categoria WHERE ((`IdCatego"& _ 
                "ria` = :Original_IdCategoria) AND ((:IsNull_Categoria = 1 AND `Categoria` IS NUL"& _ 
                "L) OR (`Categoria` = :Original_Categoria)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT IdCategoria, Categoria FROM inventariodb.categorias"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As categorias.categoriasDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As categorias.categoriasDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As categorias.categoriasDataTable = New categorias.categoriasDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As categorias.categoriasDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As categorias) As Integer
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As categorias, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._categoriasTableAdapter) Is Nothing) Then
                Dim updatedRows() As Global.System.Data.DataRow = dataSet._categorias.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.ModifiedCurrent)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As categorias, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._categoriasTableAdapter) Is Nothing) Then
                Dim addedRows() As Global.System.Data.DataRow = dataSet._categorias.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Added)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As categorias, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._categoriasTableAdapter) Is Nothing) Then
                Dim deletedRows() As Global.System.Data.DataRow = dataSet._categorias.Select(Nothing, Nothing, Global.System.Data.DataViewRowState.Deleted)
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As categorias) As Integer
            ...
            Try 
                ...
                If (Not (Me._categoriasTableAdapter) Is Nothing) Then
                    ...
                    Me._categoriasTableAdapter.Connection = CType(workConnection,Global.Devart.Data.MySql.MySqlConnection)
                    Me._categoriasTableAdapter.Transaction = CType(workTransaction,Global.System.Data.Common.DbTransaction)
            ...
            Finally
                ...
                End If
                If (Not (Me._categoriasTableAdapter) Is Nothing) Then
                    Me._categoriasTableAdapter.Connection = CType(revertConnections(Me._categoriasTableAdapter),Global.Devart.Data.MySql.MySqlConnection)
